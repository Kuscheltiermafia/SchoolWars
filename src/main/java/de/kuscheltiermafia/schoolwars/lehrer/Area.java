...
public enum Area {
    ...
    RAUM_E08("Raum E08", new Location(WORLD, 5.0, 79.0, 142.0), new Location(WORLD, 17.0, 84.0, 150.0), new Location(WORLD, 17.0, 80.0, 143.0), 1, Raum.NORMAL),
    RAUM_E09("Raum E09", new Location(WORLD, 20.0, 79.0, 142.0), new Location(WORLD, 31.0, 84.0, 151.0), new Location(WORLD, 31.0, 80.0, 143.0), 1, Raum.NORMAL),
    ...
    RAUM_111("Raum 111", new Location(WORLD, 5.0, 87.0, 142.0), new Location(WORLD, 17.0, 91.0, 150.0), new Location(WORLD, 17.0, 87.0, 143.0), 1, Raum.NORMAL),
    RAUM_112("Raum 112", new Location(WORLD, 20.0, 87.0, 142.0), new Location(WORLD, 31.0, 91.0, 150.0), new Location(WORLD, 31.0, 87.0, 143.0), 1, Raum.NORMAL),
    ...
    RAUM_117("Raum 117", new Location(WORLD,42.0, 87.0, 159.0), new Location(WORLD, 50.0, 91.0, 170.0), new Location(WORLD, 49.0, 87.0, 169.0), 1, Raum.NORMAL),
    RAUM_118("Raum 118", new Location(WORLD, 42.0, 87.0, 172.0), new Location(WORLD, 50.0, 91.0, 185.0), new Location(WORLD, 49.0, 87.0, 184.0), 1, Raum.NORMAL),
    ...
    RAUM_208("Raum 208", new Location(WORLD, 5.0, 94.0, 142.0), new Location(WORLD, 17.0, 98.0, 150.0), new Location(WORLD, 17.0, 94.0, 143.0), 1, Raum.NORMAL),
    RAUM_209("Raum 209", new Location(WORLD, 20.0, 94.0, 142.0), new Location(WORLD, 31.0, 98.0, 150.0), new Location(WORLD, 31.0, 94.0, 143.0), 1, Raum.NORMAL),
    RAUM_210("Raum 210", new Location(WORLD, 42.0, 94.0, 141.0), new Location(WORLD, 50.0, 98.0, 156.0), new Location(WORLD, 49.0, 94.0, 155.0), 1, Raum.NORMAL),
    RAUM_211("Raum 211", new Location(WORLD, 42.0, 94.0, 158.0), new Location(WORLD, 50.0, 98.0, 172.0), new Location(WORLD, 49.0, 94.0, 161.0), 1, Raum.NORMAL),
    RAUM_212("Raum 212", new Location(WORLD, 42.0, 94.0, 174.0), new Location(WORLD, 50.0, 98.0, 185.0), new Location(WORLD, 49.0, 94.0, 184.0), 1, Raum.NORMAL),
    RAUM_213("Raum 213", new Location(WORLD, 37.0, 94.0, 187.0), new Location(WORLD, 50.0, 98.0, 202.0), new Location(WORLD, 49.0, 94.0, 188.0), 1, Raum.NORMAL),
